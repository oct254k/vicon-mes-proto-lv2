...
const LOT_PREVIEW = "MFG-20260506-047";
const GATE_STATUS = { prev: "BENT", ok: true };

const HISTORY = [
  { memberId: "B01-1-G22C-C-168", lot: "MFG-20260506-044", time: "09:15" },
  { memberId: "B01-1-G22C-C-169", lot: "MFG-20260506-045", time: "10:42" },
  { memberId: "B01-1-G22C-C-170", lot: "MFG-20260506-046", time: "13:58" },
];
  ...
  return (
    <div className="max-w-sm mx-auto py-6 px-3 space-y-4">
      ...
      <div className="bg-surface-container-low border border-outline-variant/20 p-4 flex items-center justify-between">
        ...
        <StatusBadge type={GATE_STATUS.ok ? "running" : "stopped"} label={GATE_STATUS.ok ? "OK" : "BLOCKED"} />
      </div>
