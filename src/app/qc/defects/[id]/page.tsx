...
const MOCK_DETAIL = {
  ...
  wc: "WC-CUT-01",
  step: 10,
  equipmentId: "EQ-CUT-01",
  defectType: "가공",
  reasonText: "절단 길이 -2mm 단축 — 절단기 백게이지 위치 이탈 의심",
  reportedAt: "2026-05-05T08:21:00+09:00",
  reporter: "worker.han",
};
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
          {[
            ...
            <div key={item.label}>
              ...
              {item.value === null ? (
                <StatusBadge type="running" label="CONFIRMED" />
              ) : (
