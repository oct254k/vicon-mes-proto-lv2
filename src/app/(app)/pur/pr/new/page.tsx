  ...
  return (
    <div>
      ...
      <div className="bg-surface-container-low p-6 grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
        {[
          {label:"자재코드",    ph:"M-COIL-B",              type:"text"},
          {label:"자재명",      ph:"열연코일 B",             type:"text"},
          {label:"요청 수량",   ph:"300",                    type:"number"},
          {label:"단위",        ph:"m",                      type:"text"},
          {label:"납기 희망일", ph:"2026-05-09",             type:"text"},
          {label:"공장 (Plant)",ph:"P3000 제3 이천공장 (데크)", type:"text"},
        ].map(f=>(
        ...
        <div className="md:col-span-2 flex flex-col gap-1">
          ...
          <textarea rows={3} placeholder="WO-P3000-20260506-0007 M-COIL-B 240m 부족 (MRP Run #20260506-0012 근거). 내일 WO 포함 300m 긴급 조달 요청."
      ...
      {saved ? (
        ...
        <div className="flex gap-3">
          <button onClick={()=>setSaved(true)} className="px-6 py-2 bg-primary-accent text-white text-xs font-label uppercase tracking-widest">저장 (DRAFT)</button>
