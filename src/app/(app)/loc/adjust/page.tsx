...
export default function LOCAdjustPage() {
  ...
  return (
    <div>
      ...
      <form onSubmit={handleSubmit} className="bg-surface-elevated p-6 mb-8 space-y-5 max-w-lg">
        <div>
          <label className="block text-xs font-label uppercase tracking-widest text-on-surface/50 mb-2">보정 이유</label>
              ...
              <button
                ...
                className={`px-4 py-2 text-xs font-label uppercase tracking-widest border transition-colors ${
                  reason === r
                    ...
                    : "border-outline/20 text-on-surface/50 hover:border-outline/40"
                }`}
              >
                {r}
              </button>
        ...
        <div>
          <label className="block text-xs font-label uppercase tracking-widest text-on-surface/50 mb-2">Material 코드</label>
          <input
            value={matCode}
        ...
        <div>
          <label className="block text-xs font-label uppercase tracking-widest text-on-surface/50 mb-2">보정 수량</label>
          <input
            value={qty}
        ...
        <div>
          <label className="block text-xs font-label uppercase tracking-widest text-on-surface/50 mb-2">위치 선택</label>
          <select
            value={location}
        ...
        {submitted && (
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs text-on-surface/50 font-label">승인 대기 중입니다.</span>
          </div>
        )}
      </form>
