...
const RULES = [
  { rule: "Rule 1", desc: "관리 한계 밖 1점", wc: "전체", material: "전체", action: "즉시 라인 정지 + MNT 알림", priority: "CRITICAL" },
  { rule: "Rule 2", desc: "같은 방향 연속 9점", wc: "WC-CUT-01", material: "M-COIL-A", action: "QC 검사자 확인 + 원인 조사", priority: "HIGH" },
  { rule: "Rule 3", desc: "연속 6점 단조 증가/감소", wc: "WC-BEND-01", material: "전체", action: "공정 조정 요청", priority: "HIGH" },
  { rule: "Rule 4", desc: "연속 14점 교대", wc: "전체", material: "전체", action: "측정 시스템 점검", priority: "MEDIUM" },
  { rule: "Rule 5", desc: "±2σ 밖 5점 중 3점", wc: "전체", material: "M-SHEET-B", action: "QC 관리자 보고", priority: "HIGH" },
  { rule: "Rule 6", desc: "±1σ 밖 15점", wc: "전체", material: "전체", action: "공정 이상 조사", priority: "MEDIUM" },
  { rule: "Rule 7", desc: "±1σ 안 연속 15점", wc: "전체", material: "전체", action: "측정값 신뢰성 확인", priority: "LOW" },
  { rule: "Rule 8", desc: "±1σ 밖 8점 연속", wc: "전체", material: "전체", action: "공장장 즉시 보고", priority: "CRITICAL" },
];
  ...
  return (
    <div>
      ...
      <div className="flex gap-3 mb-4">
        ...
        <select className="bg-surface-container border border-outline-variant/20 text-sm px-3 py-1.5 font-label uppercase tracking-wider">
          <option>우선순위 전체</option><option>CRITICAL</option><option>HIGH</option><option>MEDIUM</option><option>LOW</option>
        </select>
