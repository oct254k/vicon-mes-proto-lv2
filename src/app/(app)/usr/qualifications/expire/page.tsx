...
export default function QualificationExpirePage() {
  return (
    <div>
      ...
      <div className="bg-surface-container-low border-l-4 border-warning p-4 mb-4 flex items-center gap-4">
      ...
      <div className="bg-surface-container-lowest">
        ...
        <table className="w-full text-left border-collapse text-sm">
          ...
          <tbody className="font-headline">
            {EXPIRE_LIST.map((q, i) => (
              <tr key={i} className={`border-b border-outline-variant hover:bg-surface-container-highest/20 ${q.status === "error" ? "bg-error/5" : "bg-warning/5"}`}>
