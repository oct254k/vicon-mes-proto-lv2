...
export default function HealthDbcatPage() {
  return (
    <div className="p-8 bg-surface min-h-screen text-on-surface">
      ...
      <div className="bg-surface-container border-l-4 border-warning p-4 mb-6 flex items-center gap-4">
      ...
      <div className="grid grid-cols-1 gap-4">
        {DBCATS.map(c => (
          <div key={c.cat} className={`bg-surface-container p-5 border-l-4 ${c.state === "running" ? "border-[#00912F]" : "border-warning"}`}>
