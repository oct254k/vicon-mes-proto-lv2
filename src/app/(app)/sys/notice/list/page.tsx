...
const RAW = [
  { id:"NTC-2026-041", title:"5월 정기 점검 공지", target:"전사",   statusKey:"PUBLISHED", priority:"보통",  author:"admin",   pubAt:"2026-05-01" },
  { id:"NTC-2026-042", title:"P2000 긴급 설비 중단", target:"P2000", statusKey:"PUBLISHED", priority:"긴급",  author:"sysop",   pubAt:"2026-05-04" },
  { id:"NTC-2026-043", title:"코드 마스터 변경 안내", target:"전사", statusKey:"DRAFT",     priority:"보통",  author:"admin",   pubAt:"—" },
  { id:"NTC-2026-040", title:"1분기 감사 결과 공유",  target:"전사", statusKey:"EXPIRED",   priority:"보통",  author:"auditor", pubAt:"2026-04-01" },
  { id:"NTC-2026-039", title:"라이선스 만료 예고",    target:"역할:ADMIN", statusKey:"PUBLISHED", priority:"높음", author:"admin", pubAt:"2026-04-28" },
  { id:"NTC-2026-038", title:"보안 패치 적용 안내",   target:"전사", statusKey:"EXPIRED",   priority:"높음",    author:"sysop",   pubAt:"2026-03-15" },
];
