...
const RECENT_VEHICLES = [
  { plate: "12라3456", passedAt: "14:32", method: "RFID" },
  { plate: "25가7890", passedAt: "11:05", method: "RFID" },
  { plate: "88다1111", passedAt: "09:48", method: "MANUAL" },
];
    ...
    <div className="min-h-screen bg-[#131313] text-white flex flex-col">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-8 py-12">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm font-label uppercase tracking-widest opacity-50 mt-2">제3공장 출하 게이트</p>
        </div>
